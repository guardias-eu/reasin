# Contributing to reasin

This outlines how to propose a change to reasin. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("guardias-eu/reasin", fork = TRUE)`.
...
Please note that the reasin project is released with a [Contributor Code
of Conduct](https://guardias-eu.github.io/reasin/CODE_OF_CONDUCT.md). By
